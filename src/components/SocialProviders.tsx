...
export default function SocialProviders({ variant = "sign-in" }: Props) {
  return (
    <div className="space-y-3">
      <button
        type="button"
        className="flex w-full items-center justify-center gap-3 rounded-xl border border-[var(--color-light-300)] bg-[var(--color-light-100)] px-4 py-3 text-body-medium text-[var(--color-dark-900)] hover:bg-[var(--color-light-200)] focus:outline-none focus:ring-2 focus:ring-[var(--color-dark-900)]/10"
