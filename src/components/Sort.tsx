...
export default function Sort() {
  ...
  return (
    <label className="inline-flex items-center gap-2">
      <span className="text-body text-[var(--color-dark-900)]">Sort by</span>
      <select
        className="rounded-md border border-[var(--color-light-300)] bg-[var(--color-light-100)] px-3 py-2 text-body"
        value={selected}
